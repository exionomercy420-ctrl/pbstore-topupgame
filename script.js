...
const GAMES = [
  ...
  {code:"R-80V", label:"80 Robux (VILOG)", oldPrice:18000, price:16500},
  {code:"R-160V", label:"160 Robux (VILOG)", oldPrice:36000, price:33000},
  {code:"R-240V", label:"240 Robux (VILOG)", oldPrice:51000, price:48500},
  {code:"R-320V", label:"320 Robux (VILOG)", oldPrice:68000, price:65000},
  {code:"R-500V", label:"500 Robux (VILOG)", oldPrice:82000, price:77000},
  {code:"R-1000V", label:"1000 Robux (VILOG)", oldPrice:160000, price:151000},
  {code:"R-1500V", label:"1500 Robux (VILOG)", oldPrice:240000, price:226000},
  {code:"R-2000V", label:"2000 Robux (VILOG)", oldPrice:320000, price:302000},
  {code:"R-2500V", label:"2500 Robux (VILOG)", oldPrice:395000, price:376000},
  {code:"R-3000V", label:"3000 Robux (VILOG)", oldPrice:470000, price:451000},
  {code:"R-4000V", label:"4000 Robux (VILOG)", oldPrice:620000, price:602000},
  {code:"R-5000V", label:"5000 Robux (VILOG)", oldPrice:780000, price:752000},
  {code:"R-10000V", label:"10000 Robux (VILOG)", oldPrice:1550000, price:1502000},
  {code:"R-450P", label:"450 Robux (PREMIUM)", oldPrice:80000, price:76000},
  {code:"R-1000P", label:"1000 Robux (PREMIUM)", oldPrice:160000, price:151000},
  {code:"R-1650P", label:"1650 Robux (PREMIUM)", oldPrice:240000, price:227000},
  {code:"R-2200P", label:"2200 Robux (PREMIUM)", oldPrice:320000, price:310000},
  {code:"R-3300P", label:"3300 Robux (PREMIUM)", oldPrice:470000, price:455000},
  {code:"R-4400P", label:"4400 Robux (PREMIUM)", oldPrice:625000, price:605000}
]},
  {id:"ff", name:"Free Fire", img:"aset/ff.jpeg", prices:[
  {code:"FF-5", label:"5 Diamond", price:1100},
  {code:"FF-12", label:"12 Diamond", price:2000},
  {code:"FF-20", label:"20 Diamond", price:3800},
  {code:"FF-25", label:"25 Diamond", price:4500},
  {code:"FF-30", label:"30 Diamond", price:5300},
  {code:"FF-40", label:"40 Diamond", price:6900},
  {code:"FF-75", label:"75 Diamond", price:10300},
  {code:"FF-80", label:"80 Diamond", price:10800},
  {code:"FF-90", label:"90 Diamond", price:13000},
  {code:"FF-120", label:"120 Diamond", price:16500},
  {code:"FF-130", label:"130 Diamond", price:18000},
  {code:"FF-150", label:"150 Diamond", price:20500},
  {code:"FF-160", label:"160 Diamond", price:21800},
  {code:"FF-180", label:"180 Diamond", price:25500},
  {code:"FF-190", label:"190 Diamond", price:26000},
  {code:"FF-200", label:"200 Diamond", price:27000},
  {code:"FF-250", label:"250 Diamond", price:34800},
  {code:"FF-280", label:"280 Diamond", price:37500},
  {code:"FF-300", label:"300 Diamond", price:40800},
  {code:"FF-375", label:"375 Diamond", price:49500},
  {code:"FF-400", label:"400 Diamond", price:52000},
  {code:"FF-405", label:"405 Diamond", price:53000},
  {code:"FF-425", label:"425 Diamond", price:54500},
  {code:"FF-475", label:"475 Diamond", price:61000},
  {code:"FF-500", label:"500 Diamond", price:64500},
  {code:"FF-510", label:"510 Diamond", price:66500},
  {code:"FF-512", label:"512 Diamond", price:67500},
  {code:"FF-545", label:"545 Diamond", price:71000},
  {code:"FF-565", label:"565 Diamond", price:72500},
  {code:"FF-600", label:"600 Diamond", price:79000},
  {code:"FF-635", label:"635 Diamond", price:82500},
  {code:"FF-645", label:"645 Diamond", price:84500},
  {code:"FF-655", label:"655 Diamond", price:85500},
  {code:"FF-770", label:"770 Diamond", price:98000},
  {code:"FF-790", label:"790 Diamond", price:100500},
  {code:"FF-800", label:"800 Diamond", price:102000},
  {code:"FF-860", label:"860 Diamond", price:110000},
  {code:"FF-930", label:"930 Diamond", price:119000},
  {code:"FF-1000", label:"1000 Diamond", price:126000},
  {code:"FF-1050", label:"1050 Diamond", price:134500},
  {code:"FF-1075", label:"1075 Diamond", price:136500},
  {code:"FF-1080", label:"1080 Diamond", price:137500},
  {code:"FF-1200", label:"1200 Diamond", price:153000},
  {code:"FF-1215", label:"1215 Diamond", price:155500},
  {code:"FF-1300", label:"1300 Diamond", price:166500},
  {code:"FF-1440", label:"1440 Diamond", price:182000},
  {code:"FF-1490", label:"1490 Diamond", price:189500},
  {code:"FF-1510", label:"1510 Diamond", price:192000},
  {code:"FF-1580", label:"1580 Diamond", price:201000},
  {code:"FF-1795", label:"1795 Diamond", price:227000},
  {code:"FF-1800", label:"1800 Diamond", price:228000},
  {code:"FF-2000", label:"2000 Diamond", price:251000},
  {code:"FF-2160", label:"2160 Diamond", price:279000},
  {code:"FF-2180", label:"2180 Diamond", price:271500},
  {code:"FF-2190", label:"2190 Diamond", price:279000},
  {code:"FF-2210", label:"2210 Diamond", price:280000},
  {code:"FF-2280", label:"2280 Diamond", price:298500},
  {code:"FF-2355", label:"2355 Diamond", price:300000},
  {code:"FF-2720", label:"2720 Diamond", price:347000},
  {code:"FF-3640", label:"3640 Diamond", price:460000},
  {code:"FF-4000", label:"4000 Diamond", price:509500}
  ]},
  {id:"pubgm", name:"PUBG Mobile", img:"aset/pubg.jpeg", prices:[
    {code:"PUBGID-30", label:"30 UC (ID)", price:8000},
    {code:"PUBGID-60", label:"60 UC (ID)", price:16500},
    {code:"PUBGID-310", label:"310 UC (ID)", price:70000},
    {code:"PUBGID-325", label:"325 UC (ID)", price:77000},
    {code:"PUBGID-660", label:"660 UC (ID)", price:153000},
    {code:"PUBGID-1563", label:"1563 UC (ID)", price:330000},
    {code:"PUBGID-1800", label:"1800 UC (ID)", price:340000},
    {code:"PUBGID-3850", label:"3850 UC (ID)", price:758000},
    {code:"PUBGID-8100", label:"8100 UC (ID)", price:1515000},
    // PUBGM GLOBAL
    {code:"PUBGGL-60", label:"60 UC Global", price:16000},
    {code:"PUBGGL-325", label:"325 UC Global", price:78000},
    {code:"PUBGGL-1800", label:"1800 UC Global", price:380000},
    {code:"PUBGGL-3850", label:"3850 UC Global", price:760000},
    {code:"PUBGGL-8100", label:"8100 UC Global", price:1550000},
    // PUBG Voucher
    {code:"PUBGV-60", label:"60 UC Voucher", price:16000},
    {code:"PUBGV-325", label:"325 UC Voucher", price:76000},
    {code:"PUBGV-660", label:"660 UC Voucher", price:151000},
    {code:"PUBGV-1800", label:"1800 UC Voucher", price:378000},
    {code:"PUBGV-3859", label:"3859 UC Voucher", price:750000}
  ]},
  {
  id:"undawn",
  name:"Undawn",
  img:"aset/undawn.jpeg",
  prices:[
    // ============================
    // KHUSUS LOG GARENA — NOTICE
    // ============================
    {code:"UND-GARENA-WP", label:"Weekly Pass (Khusus Log Garena)", price:30500},
    {code:"UND-GARENA-MP", label:"Monthly Pass (Khusus Log Garena)", price:49500},
    {code:"UND-GARENA-GF", label:"Growth Fund (Khusus Log Garena)", price:97500},
    {code:"UND-GARENA-GPP", label:"Glory Pass Premium (Khusus Log Garena)", price:147000},
    {code:"UND-GARENA-80", label:"80 RC (Khusus Log Garena)", price:15500},
    {code:"UND-GARENA-250", label:"250 RC (Khusus Log Garena)", price:45000},
    {code:"UND-GARENA-450", label:"450 RC (Khusus Log Garena)", price:75000},
    {code:"UND-GARENA-920", label:"920 RC (Khusus Log Garena)", price:148000},
    {code:"UND-GARENA-1850", label:"1850 RC (Khusus Log Garena)", price:292000},
    {code:"UND-GARENA-2800", label:"2800 RC (Khusus Log Garena)", price:439500},
    {code:"UND-GARENA-4750", label:"4750 RC (Khusus Log Garena)", price:733000},
    {code:"UND-GARENA-9600", label:"9600 RC (Khusus Log Garena)", price:1465000},
    // ============================
    // NON GARENA — NOTICE
    // ============================
    {code:"UND-NONGA-WP", label:"Weekly Pass (Non Log Garena)", price:29000},
    {code:"UND-NONGA-MP", label:"Monthly Pass (Non Log Garena)", price:46000},
    {code:"UND-NONGA-GF", label:"Growth Fund Rebate (Non Log Garena)", price:90000},
    {code:"UND-NONGA-GPP", label:"Glory Pass Premium (Non Log Garena)", price:140000},
    {code:"UND-NONGA-80", label:"80 RC (Non Log Garena)", price:14500},
    {code:"UND-NONGA-250", label:"250 RC (Non Log Garena)", price:43000},
    {code:"UND-NONGA-450", label:"450 RC (Non Log Garena)", price:72000},
    {code:"UND-NONGA-920", label:"920 RC (Non Log Garena)", price:140000},
    {code:"UND-NONGA-1850", label:"1850 RC (Non Log Garena)", price:280000},
    {code:"UND-NONGA-2800", label:"2800 RC (Non Log Garena)", price:420000},
    {code:"UND-NONGA-4750", label:"4750 RC (Non Log Garena)", price:700000},
    {code:"UND-NONGA-9600", label:"9600 RC (Non Log Garena)", price:1399000}
  ]},
  ...
  {code:"ML-WDP1", label:"1x Weekly Diamond Pass (WDP)", price:29500},
  {code:"ML-WDP2", label:"2x Weekly Diamond Pass (WDP)", price:58000},
  {code:"ML-WDP3", label:"3x Weekly Diamond Pass (WDP)", price:87000}
  ]},
  ...
  ]},
{
  id:"genshin",
  name:"Genshin Impact",
  img:"aset/genshin.jpeg",
  prices:[
    // ========= Blessing Welkin Moon =========
    {code:"GENS-W1", label:"1x Blessing Welkin Moon", price:59000},
    {code:"GENS-W2", label:"2x Blessing Welkin Moon", price:115000},
    {code:"GENS-W3", label:"3x Blessing Welkin Moon", price:177000},
    {code:"GENS-W4", label:"4x Blessing Welkin Moon", price:236000},
    {code:"GENS-W5", label:"5x Blessing Welkin Moon", price:295000},
    // ========= Genesis Crystals =========
    {code:"GENS-60", label:"60 Genesis Crystal", price:13000},
    {code:"GENS-120", label:"120 Genesis Crystal", price:25000},
    {code:"GENS-330", label:"330 Genesis Crystal", price:58000},
    {code:"GENS-1090", label:"1090 Genesis Crystal", price:176000},
    {code:"GENS-2240", label:"2240 Genesis Crystal", price:366000},
    {code:"GENS-3880", label:"3880 Genesis Crystal", price:590000},
    {code:"GENS-8080", label:"8080 Genesis Crystal", price:1142000}
  ]}
];
